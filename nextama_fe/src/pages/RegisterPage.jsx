  ...
  const handleSubmit = async (e) => {
    ...
    if (!agreedToTerms) {
      toast({
        variant: "destructive",
        title: "Lỗi",
        description: "Bạn phải đồng ý với Điều khoản dịch vụ.",
      });
      return;
    }
    try {
        ...
        <Card className="shadow-2xl glassmorphism border-primary/20">
          ...
          <CardContent className="px-6 pb-6 space-y-5">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button
                type="submit"
                className="w-full gradient-shopee text-primary-foreground text-md py-3"
